(() => {
  const CARD_CATALOG = [
    ...
    { id: 'sponserdominatie-nemelaer', title: 'Sponserdominatie Nemelaer', imageId: 'sponsorbord-nemelaer' },
    { id: 'sponserdominatie-ltv-haaren', title: 'Sponserdominatie LTV Haaren', imageId: 'sponsorbord-nemelaer' },
    { id: 'sponserdominatie-haarensklokje', title: 'Sponserdominatie Haarensklokje', imageId: 'sponsorbord-nemelaer' },
    { id: 'lopende-sponserdominatie-post', title: 'Lopende Sponserdominatie Post', imageId: 'jaarlijkse-instagram-post' },
    { id: 'fb-ads-getest-microplasticsvrij-codex', title: 'FB ads getest op Microplasticsvrij.nl via CODEX', imageId: 'softora-apple-kwaliteit-software' },
