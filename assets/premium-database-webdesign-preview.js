(function (global) {
    ...
    function renderLink(customer, options) {
        ...
        return "<a class=\"photo-compare-link\" href=\"https://www.softora.nl/webdesign/" + escapeHtml(slug) + "/concept?cid=" + escapeHtml(encodeURIComponent(id)) + "\" target=\"_blank\" rel=\"noopener\" data-public-preview-id=\"" + escapeHtml(id) + "\" aria-label=\"Open openbare previewpagina\" title=\"Open openbare pagina\">" + COMPARE_ICON + "</a>";
    }
