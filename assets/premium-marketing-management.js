    ...
    ads: {
      ...
      platforms: {
        ...
        google: {
          name: 'Google Ads',
          tone: 'monitoring',
          statusTitle: 'Google Ads staat klaar voor inrichting',
          statusNote: 'Er draait nog geen campagne en er wordt nog geen advertentiebudget uitgegeven.',
          heroTitle: 'Google Ads is geopend',
          summary: 'De Google Ads-werkruimte is klaar om zoekintentie om te zetten in nieuwe aanvragen. Campagnes gaan pas live nadat doel, regio en een concreet budget expliciet zijn goedgekeurd.',
          goal: 'Meer intentiegedreven aanvragen via Google Ads',
          goalNote: 'Eerst bepalen we welke diensten, zoekgebieden en conversies commercieel het sterkst zijn.',
          current: 'Campagnestructuur en meetplan voorbereiden',
          currentNote: 'Zoekwoorden, uitsluitingen, landingspagina’s en conversiemeting worden vóór de eerste euro gecontroleerd.',
          progress: 'Werkruimte geopend, campagne nog niet actief',
          progressNote: 'Zo voorkomen we schijnactiviteit en onverwachte advertentiekosten.',
          next: 'Doel, regio en budget expliciet vastleggen',
          nextNote: 'Na jouw akkoord op één concreet bedrag kan de eerste gecontroleerde zoekcampagne worden geactiveerd.',
        },
        linkedin: {
