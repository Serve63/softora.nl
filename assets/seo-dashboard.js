(() => {
  ...
  function renderAutomation(automation, modelOptions) {
    ...
    renderSelectOptions(elements.preferredModelSelect, modelOptions, normalizeText(safeAutomation.preferredModel || 'gpt-5.5-pro'));
    renderSelectOptions(elements.blogModelSelect, modelOptions, normalizeText(safeAutomation.blogModel || safeAutomation.preferredModel || 'gpt-5.5-pro'));
  ...
  async function optimizeSite() {
    ...
    try {
      const response = await fetchJson('/api/seo/site-optimize', {
        ...
        body: JSON.stringify({
          model: normalizeText(elements.preferredModelSelect.value || 'gpt-5.5-pro'),
  ...
  async function saveAutomation() {
    ...
    try {
      const response = await fetchJson('/api/seo/automation', {
        ...
        body: JSON.stringify({
          preferredModel: normalizeText(elements.preferredModelSelect.value || 'gpt-5.5-pro'),
          ...
          blogModel: normalizeText(elements.blogModelSelect.value || 'gpt-5.5-pro'),
