(function (global) {
    ...
    function createController(options) {
        ...
        function render(customer) {
            ...
            const mockupLoading = hasPhoto && !hasMockup;
            ...
            const mockupAriaLabel = hasMockup ? (mockupFailed ? "Device mockup kon niet geladen worden" : "Device mockup bekijken") : (mockupLoading ? "Device mockup wordt automatisch gemaakt" : "Device mockup nog niet beschikbaar");
            const mockupTitle = hasMockup ? mockupLabel : (mockupLoading ? "Device mockup wordt automatisch gemaakt" : "Maak eerst een webdesign");
            const mockupSlot = "<div class=\"photo-drop photo-drop--mockup" + (mockupLoading ? " is-generating" : "") + "\" role=\"button\" tabindex=\"0\" data-mockup-photo-id=\"" + escapeHtml(customer.id) + "\" data-has-photo=\"" + (hasMockup ? "true" : "false") + "\" data-photo-key=\"" + escapeHtml(mockupLoadKey) + "\" data-photo-loaded=\"" + (mockupLoaded || mockupFailed ? "true" : "false") + "\" data-photo-error=\"" + (mockupFailed ? "true" : "false") + "\" data-can-generate=\"" + (hasMockup ? "true" : "false") + "\" data-mockup-disabled=\"" + (hasMockup ? "false" : "true") + "\" aria-label=\"" + escapeHtml(mockupAriaLabel) + "\" title=\"" + escapeHtml(mockupTitle) + "\">" + mockupInner + "</div>";
