(function (global) {
    ...
    function createController(options) {
        ...
        function render(customer) {
            ...
            const ariaLabel = hasPhoto ? (!hasPhotoSource ? "Websitefoto beschikbaar; detaildata laadt op de achtergrond" : (photoFailed ? "Websitefoto kon niet geladen worden" : "Websitefoto bekijken")) : (isLoading ? (isPending ? "Webdesign wordt gemaakt" : "Websitefoto's worden hersteld") : (canGenerate ? "Webdesign maken" : "Geen geldige website gevonden"));
