    ...
    function createController(options) {
        ...
        function stripPhotoMeta(item) {
            return {
                ...
                webdesignMailProvider: normalizeString(item && item.webdesignMailProvider),
        ...
        function parsePhotoMapDetailed(raw, values, customers) {
            ...
            (Array.isArray(customers) ? customers : []).forEach(function (customer, index) {
                ...
                result[normalized.id] = {
                    ...
                    webdesignMailProvider: normalized.webdesignMailProvider || "",
        ...
        function mergePhotoMaps(existing, current, removeIds) {
            ...
            function mergeMeta(existingMeta, currentMeta) {
                ...
                return stripPhotoMeta({
                    ...
                    webdesignMailProvider: next.webdesignMailProvider || base.webdesignMailProvider,
