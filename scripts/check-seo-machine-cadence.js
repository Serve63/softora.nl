    ...
    const runGate = cadence.exitCode === 0 || cadence.exitCode === 2
      ? recordAutomationRunGateFromCli({
        ...
        details: {
          ...
          publicationStrategy: cadence.publicationStrategy,
          targetNewUrlsPerWeek: cadence.targetNewUrlsPerWeek,
          newUrlTargetGap: cadence.newUrlTargetGap,
          allowedPublicationLanes: cadence.allowedPublicationLanes,
