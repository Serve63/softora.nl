...
if (!championStrategy) {
  ...
  console.log(JSON.stringify({
    ...
    challenger: review.challenger ? {
      ...
      rollingReturnPct: pct(review.challenger.rolling?.strategyCompoundReturn || 0),
      rollingBenchmarkPct: pct(review.challenger.rolling?.benchmarkCompoundReturn || 0),
      rollingBeatRatePct: pct(review.challenger.rolling?.beatRate || 0),
