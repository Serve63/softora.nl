...
function loadRuntimeEnv(env = process.env) {
  ...
  return {
    ...
    ai: {
      ...
      openaiModel: safeEnv.OPENAI_MODEL || 'gpt-5.5-pro',
      openaiImageModel:
        safeEnv.WEBSITE_PREVIEW_IMAGE_MODEL || safeEnv.OPENAI_IMAGE_MODEL || 'gpt-image-2.5-sunburst',
      anthropicApiBaseUrl: '',
      anthropicModel: '',
    ...
    instantly: {
      ...
      autoApprovedCampaigns: normalizeString(safeEnv.INSTANTLY_AUTO_APPROVED_CAMPAIGNS_JSON || ''),
