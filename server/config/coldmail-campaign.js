...
// Absorb cron/startup drift without changing the independent per-mailbox cooldown.
const COLDMAIL_AUTOPILOT_INTERVAL_READY_GRACE_MS = 30 * 1000;
...
const COLDMAIL_AUTOPILOT_KNOWN_SKIP_CODES = new Set([
  ...
  'COLDMAIL_HISTORICAL_MAILBOX_GUARD_UNAVAILABLE',
  'COLDMAIL_OUTBOUND_LEDGER_UNAVAILABLE',
...
module.exports = {
  ...
  COLDMAIL_AUTOPILOT_INTERVAL_READY_GRACE_MS,
