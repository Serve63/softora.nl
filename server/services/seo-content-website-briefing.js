const WEBSITE_BRIEFING_CONTENT_ITEM = Object.freeze({
  collection: 'blog',
  slug: 'website-briefing-maken-mkb',
  title: 'Website briefing maken: praktische aanpak voor het MKB',
  description:
    'Leg doelgroep, doelen, pagina\'s, content, functies, SEO, koppelingen, beheer en acceptatie vast vóór je websiteoffertes aanvraagt.',
  category: 'Websites',
  intent: 'Implementatie',
  qualityVersion: 2,
  primaryIntent: 'Een complete websitebriefing opstellen voordat bureaus een voorstel of offerte maken',
  buyerTask:
    'Besluiten, open vragen, eigenaarschap en acceptatiebewijs per websiteonderdeel vastleggen zodat leveranciers dezelfde afgebakende opdracht ontvangen',
  funnelStage: 'consideration',
  targetMoneyPage: '/website-laten-maken',
  uniqueClusterRole:
    'Opdrachtvoorbereiding vóór leveranciers- en offertekeuze; de offertegids vergelijkt ontvangen voorstellen, de paginagids kiest inhoudsrollen en de kostengids begroot de scope.',
  informationGain:
    'Een kopieerbaar briefingregister waarin ieder websiteonderdeel een besluit, status, eigenaar, aanlevermoment, acceptatiebewijs en expliciete open vraag krijgt, plus een go-no-go tussen briefing, offerte, prototype en livegang.',
  sources: Object.freeze([
    Object.freeze({
      title: '2manydots: Website briefing schrijven',
      url: 'https://www.2manydots.nl/kenniscentrum/website-briefing',
      observedAt: '2026-08-30',
    }),
    Object.freeze({
      title: 'Frankwatching: In 9 stappen naar de perfecte briefing voor een nieuwe website',
      url: 'https://www.frankwatching.com/archive/2023/09/20/briefing-website-stappenplan/',
      observedAt: '2026-08-30',
    }),
    Object.freeze({
      title: 'Tasmanic: Website briefing maken in 8 stappen',
      url: 'https://www.tasmanic.nl/blog/briefing-nieuwe-website/',
      observedAt: '2026-08-30',
    }),
  ]),
  ...
  visualBrief: Object.freeze({
    hero: Object.freeze({
      ...
      visualFamily: 'corkboard-briefing-evidence-wall',
      composition:
        'Brede documentaire briefingwand met pagina-silhouetten, doelgroepfiches, content- en functiebewijs, controlekoorden en een apart wachtende offerte-envelop.',
      informationGoal:
        'Laat zien dat een websitebriefing meerdere samenhangende besluiten en eigenaars nodig heeft voordat een leverancier eerlijk kan offreren.',
      differenceFromRecent:
        'Verticale kurk- en textielwand met ruimtelijke daglichtfotografie, zonder werktafel, personen, donker dashboard, witte isometrische tegels of zwevende UI-kaarten.',
    ...
    support: Object.freeze({
      ...
      visualFamily: 'aubergine-linocut-briefing-route',
      composition:
        'Asymmetrische crèmekleurige route op aubergine linodruk van briefingdossier via offertes en prototype naar menselijke acceptatie en livegang, met koraalrode herstelboog.',
      informationGoal:
        'Leg uit dat een onvolledige scope of ontbrekend bewijs vóór acceptatie teruggaat naar de briefing in plaats van stilzwijgend naar livegang.',
      differenceFromRecent:
        'Volvlak aubergine linodruk met grove grote symbolen en één herstelboog, zonder fotografie, blauwe transitkaart, gele Zwitserse poster, dashboard of tekstlabels.',
      sourceType: 'trainedAlgorithmicMedia',
      textDensity: 'none',
      previewSafe: false,
    }),
  ...
  image: Object.freeze({
    src: '/assets/seo-content/website-briefing-maken-mkb-hero.jpg',
    alt: 'Documentaire briefingwand met websitepagina\'s, doelgroepfiches, content, functies, controles en een apart wachtende offerte-envelop.',
    width: 1672,
    height: 941,
    sourceType: 'trainedAlgorithmicMedia',
  }),
  secondaryImage: Object.freeze({
    src: '/assets/seo-content/website-briefing-maken-mkb-route.jpg',
    alt: 'Linodrukroute van briefing via vergelijkbare offertes en prototype naar menselijke acceptatie en livegang, met een herstelroute terug.',
    width: 1672,
    height: 941,
    sourceType: 'trainedAlgorithmicMedia',
    caption:
      'Gaat een voorstel, prototype of test uit van een open aanname, stuur die beslissing terug naar het briefingregister voordat de volgende fase begint.',
  }),
  keywordEvidence: Object.freeze({
    ...
    seeds: Object.freeze(['website briefing maken']),
    tools: Object.freeze([
      'keyword_suggestions',
      'google_suggestions',
      'keyword_overview',
    ...
    calls: Object.freeze([
      Object.freeze({
        ...
        observedAt: '2026-08-30',
        arguments: Object.freeze({ keywords: Object.freeze(['website briefing maken']), locId: 2528, language: 'Dutch' }),
        purpose: 'Gerelateerde Nederlandse koperstaal vinden.',
      }),
      Object.freeze({
        tool: 'google_suggestions',
        observedAt: '2026-08-30',
        arguments: Object.freeze({ keywords: Object.freeze(['website briefing maken']), country: 'nl', language: 'Dutch' }),
        purpose: 'Werkelijke Nederlandse autocompletevarianten controleren.',
      }),
      Object.freeze({
        tool: 'keyword_overview',
        observedAt: '2026-08-30',
        arguments: Object.freeze({ keyword: 'website briefing maken', locId: 2528, language: 'Dutch' }),
        purpose: 'Providerinschattingen en effectieve locale vastleggen.',
      }),
      Object.freeze({
        tool: 'serp_analysis',
        observedAt: '2026-08-30',
        arguments: Object.freeze({ keyword: 'website briefing maken', locId: 2528, language: 'Dutch', limit: 5 }),
        purpose: 'Dominante Nederlandse paginatypen en SERP-vormen controleren.',
      }),
    ]),
    primaryIntent: 'Een bruikbare websitebriefing opstellen voordat offertes en bouwbesluiten worden vastgelegd.',
    provisionalPrimaryTerm: 'website briefing maken',
    secondaryBuyerLanguage: Object.freeze([
      'website briefing template',
      'website briefing document template',
    ]),
    buyerQuestions: Object.freeze([
      'Wat moet er in een website briefing staan?',
      'Welke beslissingen moeten vaststaan voordat offertes worden vergeleken?',
    ]),
    dominantPageTypes: Object.freeze(['stappenplan', 'template', 'praktische checklist']),
    serpFeatures: Object.freeze(['ai_overview']),
    limitations: Object.freeze([
      'Ubersuggest is adviserend en bepaalt selectie, structuur of formulering niet.',
      'Volume nul is no_measurable_provider_volume en bewijst niet dat er geen vraag is.',
      'De seed heeft geen provider-intentielabel en de SERP-data is van 2026-08-27.',
    ]),
    terms: Object.freeze([
      Object.freeze({
        phrase: 'website briefing maken',
        disposition: 'used',
        reason: 'Dekt de concrete koperstaak natuurlijk en zonder exacte-matchquota.',
        metrics: Object.freeze({ volume: 0, seoDifficulty: 12 }),
      ...
      Object.freeze({
        phrase: 'website briefing template',
        disposition: 'covered_semantically',
        reason: 'De pagina biedt een kopieerbare invulstructuur zonder een downloadclaim te doen.',
        observedIn: Object.freeze(['google_suggestions']),
      }),
      Object.freeze({
        phrase: 'website briefing document template',
        disposition: 'rejected',
        reason: 'De Engelstalige formulering past niet natuurlijk in Nederlandse paginacopy.',
        observedIn: Object.freeze(['google_suggestions']),
      }),
    ]),
    decision: Object.freeze({
      ...
      rationale:
        'GSC, de bindende redactionele backlog, de koperstaak, publieke SERP en Softora-overlapcontrole bepalen de pagina.',
    }),
  }),
  summary:
    'Een goede websitebriefing is geen wensenlijst voor kleur en vorm. Het is een beslisregister dat doel, doelgroep, pagina\'s, inhoud, functies, gegevens, meting, eigenaarschap en acceptatie op één controleerbare scope brengt voordat leveranciers offreren.',
  sections: Object.freeze([
    Object.freeze({
      heading: 'Het korte antwoord: maak een beslisregister, geen verlanglijst',
    ...
    Object.freeze({
      heading: 'Begin bij bedrijfsdoel, doelgroep en gewenste actie',
      paragraphs: Object.freeze([
    ...
    Object.freeze({
      heading: 'Maak een pagina- en contentkaart met eigenaar en bewijs',
      paragraphs: Object.freeze([
        Object.freeze({
          text:
    ...
    Object.freeze({
      heading: 'Beschrijf functies als gebruikersroute met foutpad',
      paragraphs: Object.freeze([
    ...
    Object.freeze({
      heading: 'Leg SEO, meten, privacy en toegankelijkheid als oplevering vast',
      paragraphs: Object.freeze([
    ...
    Object.freeze({
      heading: 'Maak stijlrichting bruikbaar zonder het ontwerp al dicht te zetten',
      paragraphs: Object.freeze([
    ...
    Object.freeze({
      heading: 'Zet planning op besluiten en aanleveringen, niet alleen op bouwweken',
      paragraphs: Object.freeze([
    ...
    Object.freeze({
      heading: 'Definieer acceptatie en beheer vóór je offertes vergelijkt',
      paragraphs: Object.freeze([
    ...
    Object.freeze({
      heading: 'Kopieer deze minimale briefingstructuur',
      paragraphs: Object.freeze([
        ...
        Object.freeze({
          ...
          links: Object.freeze([
            Object.freeze({ anchor: 'websitepakketten', href: '/pakketten' }),
          ]),
        }),
      ]),
    }),
  ...
  relatedLinks: Object.freeze([
    ...
    Object.freeze({ label: 'Websiteoffertes vergelijken', href: '/blog/website-offerte-vergelijken' }),
    ...
    Object.freeze({ label: 'Website migreren', href: '/kennisbank/website-migratie-zonder-seo-verlies' }),
