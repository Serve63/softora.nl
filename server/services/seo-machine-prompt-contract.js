const AUTOMATION_PROMPT_VERSION = 11;
const REQUIRED_PROMPT_MARKERS = Object.freeze([
  Object.freeze({ label: 'prompt_version', pattern: /SEO_MACHINE_PROMPT_VERSION=11/ }),
  ...
  Object.freeze({ label: 'academy_blog_scope', pattern: /SEO_ACADEMY_CONTENT_POLICY=blogs_only/ }),
