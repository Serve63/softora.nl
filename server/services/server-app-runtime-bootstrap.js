...
function buildServerAppEnvConfig(runtimeEnv) {
  ...
  return {
    ...
    AGENDA_APP_PIN: runtimeEnv.premiumAuth.agendaAppPin,
    AGENDA_APP_PIN_HASH: runtimeEnv.premiumAuth.agendaAppPinHash,
    AGENDA_APP_SERVE_EMAIL: runtimeEnv.premiumAuth.agendaAppServeEmail,
    AGENDA_APP_MARTIJN_EMAIL: runtimeEnv.premiumAuth.agendaAppMartijnEmail,
    AGENDA_APP_SESSION_TTL_DAYS: runtimeEnv.premiumAuth.agendaAppSessionTtlDays,
    ...
    COLDMAIL_REPLY_SYNC_EMAIL: runtimeEnv.mail.coldmailReplySyncEmail,
    ...
    COLDMAIL_BOUNCE_PROCESSING_ENABLED: runtimeEnv.mail.coldmailBounceProcessingEnabled,
    COLDMAIL_CAMPAIGN_SEND_LIMIT: runtimeEnv.mail.coldmailCampaignSendLimit,
    COLDMAIL_DAILY_SEND_LIMIT: runtimeEnv.mail.coldmailDailySendLimit,
    COLDMAIL_PACKAGE_DAILY_SEND_LIMIT: runtimeEnv.mail.coldmailPackageDailySendLimit,
    COLDMAIL_SEND_DELAY_MS: runtimeEnv.mail.coldmailSendDelayMs,
    COLDMAIL_SAFETY_PAUSE_MS: runtimeEnv.mail.coldmailSafetyPauseMs,
    ...
    COLDMAIL_SEND_WINDOW_START: runtimeEnv.mail.coldmailSendWindowStart,
    COLDMAIL_SEND_WINDOW_END: runtimeEnv.mail.coldmailSendWindowEnd,
    COLDMAIL_SEND_WINDOW_TIMEZONE: runtimeEnv.mail.coldmailSendWindowTimeZone,
    COLDMAIL_HOURLY_PACING_ENABLED: runtimeEnv.mail.coldmailHourlyPacingEnabled,
    COLDMAIL_WEEKDAYS_ONLY: runtimeEnv.mail.coldmailWeekdaysOnly,
