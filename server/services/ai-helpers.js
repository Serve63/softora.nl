function createAiHelpers(deps = {}) {
  ...
  function getOpenAiModelCostRates(model) {
    ...
    if (key.includes('gpt-5.5-pro')) return { inputPer1mUsd: 30, outputPer1mUsd: 180, source: 'default-gpt5.5-pro' };
    if (key.includes('gpt-5.5')) return { inputPer1mUsd: 1.25, outputPer1mUsd: 10.0, source: 'default-gpt5.5' };
