...
const CAMPAIGN_LAUNCH_PACKS = Object.freeze([
  {
    ...
    finalUrl: 'https://www.softora.nl/website-laten-maken',
    sourceFile: 'premium-websites.html',
    path1: 'website',
    path2: 'vaste-prijs',
    headlines: [
      'Website Laten Maken',
      'Vaste Prijs Van € 3.950',
      'Binnen 10 Werkdagen',
      'Zeven Sterke Pagina’s',
      'SEO En Leadflow Inbegrepen',
      'Geen Open Einde',
      'Voor Dienstverlenend MKB',
      'Softora Groeiwebsite',
      'Eén Heldere Websiteprijs',
      'Start Met De Vaste Intake',
      'Gebouwd Voor Meer Aanvragen',
      'Bekijk De Volledige Scope',
    ],
    descriptions: [
      'Een zakelijke groeiwebsite voor € 3.950 excl. btw, met zeven pagina’s en SEO-basis.',
      'Vaste scope en binnen 10 werkdagen een eerste complete versie ter beoordeling.',
      'Inclusief copy, responsive bouw, leadformulier, analytics en één gebundelde revisieronde.',
      'Bekijk direct wat wel en niet inbegrepen is en start zonder vrijblijvend verkoopgesprek.',
    ],
    keywords: [
      { text: 'website laten maken', matchType: 'EXACT' },
      { text: 'website laten maken', matchType: 'PHRASE' },
      { text: 'professionele website laten maken', matchType: 'EXACT' },
      { text: 'professionele website laten maken', matchType: 'PHRASE' },
      { text: 'zakelijke website laten maken', matchType: 'EXACT' },
      { text: 'website laten maken brabant', matchType: 'PHRASE' },
    ],
  },
  {
...
function buildGoogleAdsLaunchPack(options = {}) {
  ...
  return {
    ...
    tracking: {
      ...
      primaryConversion: 'Voltooide website-intake; WhatsApp blijft secundair',
