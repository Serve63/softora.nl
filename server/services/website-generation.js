function createWebsiteGenerationHelpers(deps = {}) {
  ...
  function formatWebsitePreviewCustomerIdentityLock() {
    return [
      'KLANTIDENTITEIT EN OUTREACH-SCHEIDING (verplicht boven alle andere context):',
      '- De output toont uitsluitend de website van het gescande klantbedrijf; context over de maker of verzender hoort buiten deze websiteafbeelding.',
      '- Voeg geen afzender, webdesigner, softwareontwikkelaar, maker, auteur, outreach-profiel, avatar, makerbio, persoonlijke pitch of ik-vorm uitleg over het ontwerpproces toe.',
      '- Voeg geen persoonsnaam, portret of teamlid toe tenzij die identiteit aantoonbaar en inhoudelijk relevant op de gescande klantwebsite staat.',
      '- Gebruik nooit profielgegevens van de gebruiker, softwareleverancier of verkooppartij in navigatie, content, kaarten, afbeeldingen, testimonials of footer.',
    ]
      .filter(Boolean)
      .join('\n');
  }
