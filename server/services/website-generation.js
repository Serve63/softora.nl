  ...
  function buildWebsitePreviewPromptFromScan(scan = {}) {
    ...
    return [
      ...
      referenceImageCount
        ...
        : '',
      'Genereer een volledig nieuw ultra-premium full-page desktop homepage-concept dat inhoudelijk sterk blijft aansluiten op de bronsite.',
      'Vertaal het huidige aanbod, diensten en "wat we doen" direct en trouw naar de nieuw gegenereerde variant: behoud kernboodschap, doelgroep, waardeproposities, CTA-logica en de commerciële volgorde van de secties.',
