...
test('Lead Radar page, sidebar and user-visible website labels are wired', () => {
  ...
  assert.match(page, /lead-radar\.css\?v=20260818d/);
  assert.match(page, /lead-radar\.js\?v=20260818d/);
  ...
  assert.doesNotMatch(page, /<select id="scan-platforms"/);
  ...
  assert.match(script, /setPlatformDropdownOpen/);
