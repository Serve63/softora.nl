...
test('Lead Radar page, sidebar and user-visible website labels are wired', () => {
  ...
  assert.equal(createKnownPrettyPageSlugToFile(new Set(['premium-lead-radar-shell.html']))
    .get('lead-radar'), 'premium-lead-radar-shell.html');
...
test('Lead Radar wordt via de centrale HTML-deliverylaag in de premium-sidebar geladen', () => {
  ...
  assert.match(htmlPages, /PREMIUM_PERSONNEL_THEME_VERSION = '20260922-design'/);
