...
test('marketing premium landing pages are not auth-gated', () => {
  ...
  assert.equal(controller.isPremiumProtectedHtmlFile('premium-world-watcher.html'), true);
  ...
  assert.equal(controller.isPremiumProtectedHtmlFile('sportschool.html'), false);
  ...
  assert.equal(controller.isPremiumAdminOnlyHtmlFile('premium-world-watcher.html'), true);
  ...
  assert.equal(controller.isPremiumAdminOnlyHtmlFile('sportschool.html'), false);
});
