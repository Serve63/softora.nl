...
test('unused company totals and website subcategories form one labelled group', () => {
  ...
  assert.doesNotMatch(group, /id="companies-successful-found"|id="companies-treated"/);
});
...
test('kvk database keeps last-hour deltas in eight cards with controller decisions', () => {
  ...
  assert.match(pageSource, /assets\/kvk-database-metrics\.css\?v=20260916-purple-cards/);
