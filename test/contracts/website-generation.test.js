...
test('website generation helpers build preview prompt, brief and filename from scan data', () => {
  ...
  assert.doesNotMatch(prompt, /Gebruik dezelfde globale structuur waar mogelijk/i);
  ...
  assert.match(prompt, /VOLLEDIG GELADEN STAAT/i);
  assert.match(prompt, /alle secties, afbeeldingen, kaarten en previews klaar zijn/i);
