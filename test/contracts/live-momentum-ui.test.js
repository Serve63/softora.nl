...
test('live momentum page renders the requested dashboard surface', () => {
  ...
  assert.match(html, /<script src="\/assets\/live-momentum-endgame-cards\.js\?v=20260809b" defer><\/script>/);
...
test('live momentum script wires habit toggles to chart and persisted state', () => {
  ...
  assert.match(endGameCardsJs, /live-momentum-endgame-cards\/\$\{card\.imageId \|\| card\.id\}\.png\?v=20260809b/);
