...
test('live momentum page renders the requested dashboard surface', () => {
  ...
  assert.match(html, /href="\/assets\/live-momentum\.css\?v=20260716m"/);
  ...
  assert.match(html, /<script src="\/assets\/live-momentum\.js\?v=20260716f" defer><\/script>/);
  ...
  assert.match(html, /<article class="end-game-goal-card end-game-goal-card--mission" aria-label="Missie: Eigen automaat rijden">/);
