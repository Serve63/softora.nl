...
test('public webdesign preview concept route renders the experimental supplied layout separately', async () => {
  ...
  assert.match(response.body, /@media\(max-width:700px\)\{\.about-section\{gap:28px\}\.about-profile\{width:min\(100%,320px\);justify-content:flex-start\}\.about-photo\{width:58px;flex-basis:58px\}\.profile-signature span\{white-space:nowrap;font-size:clamp\(8px,2\.5vw,10px\);letter-spacing:\.7px\}\.about-text h2\{font-size:clamp\(13px,4\.1vw,22px\);text-align:center\}\}/);
