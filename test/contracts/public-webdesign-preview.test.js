...
test('public webdesign preview concept route renders the experimental supplied layout separately', async () => {
  ...
  assert.match(response.body, /\.about-text p\{font-size:14px;color:var\(--muted\);line-height:1\.85;margin-bottom:12px;text-align:center\}/);
