...
test('premium instellingen gebruikt delegated actions zonder inline handlers', () => {
  ...
  assert.match(moduleRoutesSource, /Vakantiescanner/);
  assert.doesNotMatch(moduleRoutesSource, /Flynow/);
  assert.match(moduleRoutesSource, /Transfermarkt/);
  assert.doesNotMatch(moduleRoutesSource, /OMZETWERK/);
  assert.doesNotMatch(moduleRoutesSource, /Ruben’s Trading System/);
