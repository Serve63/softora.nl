...
test('premium database toont Supabase-hapering zonder data als leeg te presenteren', () => {
  ...
  assert.match(pageSource, /assets\/premium-database-webdesign-mockup\.js\?v=20260606a/);
  ...
  assert.match(webdesignMockupScriptSource, /const DEVICE_MOCKUP_VERSION = "v11";/);
  assert.match(webdesignMockupScriptSource, /const MOCKUP_BACKGROUND_SRC = "\/assets\/webdesign-preview-stage-bg\.jpg";/);
  assert.match(webdesignMockupScriptSource, /function loadMockupBackground\(\)/);
  assert.match(webdesignMockupScriptSource, /function drawStageBackground\(context, backgroundImage\)/);
  assert.match(webdesignMockupScriptSource, /function drawModernLaptopBase\(context, device\)/);
  assert.match(webdesignMockupScriptSource, /function drawLaptopKeyboard\(context, device, left, deckTopY\)/);
  assert.match(webdesignMockupScriptSource, /baseStyle: "modern-laptop"/);
  assert.match(webdesignMockupScriptSource, /deckBottomY - 72, device\.baseW \* 0\.22, 48, 10/);
  assert.match(webdesignMockupScriptSource, /deckGradient\.addColorStop\(0, "#202b3d"\);/);
  assert.match(webdesignMockupScriptSource, /context\.fillStyle = "rgba\(148, 163, 184, 0\.32\)";/);
  assert.match(webdesignMockupScriptSource, /count: 14, keyW: 38/);
  ...
  assert.doesNotMatch(webdesignMockupScriptSource, /rgba\(59, 130, 246, 0\.10\)/);
