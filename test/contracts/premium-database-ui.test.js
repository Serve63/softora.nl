...
test('premium database toont Supabase-hapering zonder data als leeg te presenteren', () => {
  ...
  assert.match(pageSource, /assets\/premium-database-webdesign-asset-state\.js\?v=20260923-normalized/);
  ...
  assert.match(pageSource, /assets\/premium-database-filter-groups\.css\?v=20260922-today-channel-total/);
  assert.match(pageSource, /assets\/premium-database-system-mail-count\.js\?v=20260923-date-cache/);
