...
test('premium bevestigingsmails places sender dropdown in the campaign card and compact settings behind the gear', () => {
  ...
  assert.match(pageSource, /const allowedSenderEmails = new Set\(\['serve@softora\.nl', 'martijn@softora\.nl', 'servec321@gmail\.com', 'martijnven123@gmail\.com', 'serve290@gmail\.com', 'servecreusen7@gmail\.com'\]\);/);
