...
test('mailbox gebruikt de juiste browsertitel', () => {
  ...
  assert.match(readPage(), /assets\/premium-mailbox\.js\?v=20260806f/);
  assert.match(readPage(), /assets\/premium-mailbox-refresh\.js\?v=20260809a/);
  assert.match(readPage(), /assets\/premium-mailbox-owner-session\.js\?v=20260809a/);
  assert.match(readPage(), /assets\/premium-mailbox-owner-preference\.js\?v=20260806a/);
  assert.match(readPage(), /assets\/premium-mailbox-snapshot-freshness\.js\?v=20260809a/);
  assert.match(readPage(), /assets\/premium-mailbox-campaign-inbox\.js\?v=20260809a/);
...
test('premium mailbox uses an owner filter in the coldmail topbar', () => {
  ...
  assert.match(pageSource, /assets\/premium-mailbox-refresh\.js\?v=20260809a/);
  assert.match(pageSource, /assets\/premium-mailbox\.js\?v=20260806f/);
