...
test('mailbox gebruikt de juiste browsertitel', () => {
  ...
  assert.match(page, /assets\/premium-mailbox-campaign-inbox\.js\?v=20260924c/);
  ...
  assert.ok(page.indexOf('premium-mailbox-detail-stability.js?v=20260924c') < page.indexOf('premium-mailbox-index.js?v=20260924a'));
...
test('accountlijst hervat overgeslagen tijdlijn van cached mailbox terwijl providerlookup nog loopt', async () => {
  ...
  // A slow provider lookup no longer blocks reading once the short hold has passed.
