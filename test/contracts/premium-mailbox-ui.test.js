...
test('mailbox gebruikt de juiste browsertitel', () => {
  ...
  assert.match(page, /assets\/premium-mailbox-compose-send-resilience\.js\?v=20260828d/);
  ...
  assert.ok(page.indexOf('premium-mailbox-attachment-digest.js?v=20260828c') < page.indexOf('premium-mailbox-compose-send-resilience.js?v=20260828d'));
  assert.ok(page.indexOf('premium-mailbox-compose-send-resilience.js?v=20260828d') < page.indexOf('premium-mailbox-compose-accepted-send.js?v=20260827b'));
  assert.ok(page.indexOf('premium-mailbox-compose-accepted-send.js?v=20260827b') < page.indexOf('premium-mailbox-compose-controller.js?v=20260828e'));
...
test('premium mailbox compose gebruikt Softora styling zonder dubbele verwijderknop', () => {
  ...
  assert.match(pageSource, /assets\/premium-mailbox-compose-send-resilience\.js\?v=20260828d/);
  assert.match(pageSource, /assets\/premium-mailbox-compose-accepted-send\.js\?v=20260827b/);
  assert.match(pageSource, /assets\/premium-mailbox-compose-controller\.js\?v=20260828e/);
