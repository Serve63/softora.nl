...
test('premium mailbox behoudt alleen de vaste premium-sidebar bij responsive mailweergave', () => {
  ...
  assert.match(pageSource, /assets\/premium-mailbox-campaign-inbox\.js\?v=20260907b/);
  ...
  const sendResilienceAssetIndex = pageSource.indexOf('assets/premium-mailbox-compose-send-resilience.js?v=20260831c');
