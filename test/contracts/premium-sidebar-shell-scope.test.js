...
test('premium mailbox behoudt alleen de vaste premium-sidebar bij responsive mailweergave', () => {
  ...
  assert.match(pageSource, /\.detail-mail-contact-item\.detail-mail-contact-item-phone \{[^}]*display:\s*flex;[^}]*gap:\s*0 \.35em;/);
