...
test('kvk database route keeps the canonical sidebar outside its scraper frame', () => {
  ...
  assert.match(directoryShellSource, /assets\/kvk-database-total-found\.js\?v=20260910c/);
  ...
  assert.match(dashboardSource, /assets\/kvk-database-total-found\.js\?v=20260910c/);
...
test('premium mailbox behoudt alleen de vaste premium-sidebar bij responsive mailweergave', () => {
  ...
  assert.match(pageSource, /assets\/premium-mailbox-signature\.js\?v=20260909e/);
