...
test('premium database consistency assets stay outside the static sidebar', () => {
  ...
  assert.ok(source.indexOf('assets/premium-database-mail-ready-snapshot.js?v=20260805f') > asideEnd);
...
test('kvk database route keeps the canonical sidebar outside its scraper frame', () => {
  ...
  assert.doesNotMatch(directoryShellSource, /assets\/kvk-database\.css/);
