...
test('html page coordinator injects critical premium sidebar shell before theme stylesheet', async () => {
  ...
  assert.match(res.body, /\/assets\/premium-sidebar-stability\.css\?v=20260519d/);
  assert.match(res.body, /\/assets\/premium-sidebar-stability\.js\?v=20260519d/);
  assert.match(res.body, /\/assets\/premium-sidebar-autopilot\.css\?v=20260609a/);
  assert.match(res.body, /\/assets\/premium-sidebar-autopilot\.js\?v=20260609a/);
