  ...
  for (const file of pages) {
    ...
    if (file !== 'premium-instellingen.html') {
      if (file === 'premium-actieve-opdrachten.html') {
        ...
        assert.match(source, /<script src="assets\/premium-ui-state-client\.js\?v=20260723c"><\/script>[\s\S]*<script src="assets\/premium-mailbox-delete\.js\?v=20260820a"><\/script><script src="assets\/premium-browser-storage\.js\?v=20260814a"><\/script><script src="assets\/premium-mailbox-state-outbox\.js\?v=20260825c"><\/script><script src="assets\/premium-mailbox-read\.js\?v=20260825c"><\/script><script src="assets\/premium-mailbox-ui-state\.js\?v=20260818a"><\/script>\s*<script src="assets\/premium-mailbox-boot\.js\?v=20260806a"><\/script><script src="assets\/premium-mailbox\.js\?v=20260824a"><\/script>/, file);
