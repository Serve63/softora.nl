  ...
  for (const file of pages) {
    ...
    if (file !== 'premium-instellingen.html') {
      if (file === 'premium-actieve-opdrachten.html') {
        ...
        assert.match(source, /<script src="assets\/premium-campaign-sender-settings\.js\?v=20260511a"><\/script><script src="assets\/premium-mailbox\.js\?v=20260511b"><\/script>/, file);
