  ...
  for (const file of pages) {
    ...
    if (file !== 'premium-instellingen.html') {
      if (file === 'premium-actieve-opdrachten.html') {
        ...
        assert.match(source, /<script src="assets\/premium-ui-state-client\.js\?v=20260723c"><\/script><script src="assets\/premium-campaign-sender-settings\.js\?v=20260722a"><\/script><script src="assets\/premium-mailbox-outreach\.js\?v=20260720b"><\/script><script src="assets\/premium-mailbox-message-identity\.js\?v=20260810a"><\/script><script src="assets\/premium-mailbox-owner-session\.js\?v=20260810b"><\/script><script src="assets\/premium-mailbox-owner-preference\.js\?v=20260806a"><\/script><script src="assets\/premium-mailbox-message-provenance\.js\?v=20260728a"><\/script><script src="assets\/premium-mailbox-quoted-thread\.js\?v=20260806b"><\/script><script src="assets\/premium-mailbox-snapshot-freshness\.js\?v=20260810b"><\/script><script src="assets\/premium-mailbox-request-deadline\.js\?v=20260809a"><\/script><script src="assets\/premium-mailbox-campaign-inbox\.js\?v=20260810c"><\/script><script src="assets\/premium-mailbox-images\.js\?v=20260724c"><\/script><script src="assets\/premium-mailbox-display\.js\?v=20260806a"><\/script><script src="assets\/premium-mailbox-list\.js\?v=20260804d"><\/script><script src="assets\/premium-mailbox-index\.js\?v=20260810b"><\/script><script src="assets\/premium-mailbox-refresh\.js\?v=20260810a"><\/script><script src="assets\/premium-mailbox-compose\.js\?v=20260810b"><\/script><script src="assets\/premium-mailbox-compose-window\.js\?v=20260803a"><\/script><script src="assets\/premium-mailbox-compose-controller\.js\?v=20260810b"><\/script><script src="assets\/premium-mailbox-toast\.js\?v=20260724a"><\/script><script src="assets\/premium-mailbox-delete\.js\?v=20260810b"><\/script><script src="assets\/premium-mailbox-read\.js\?v=20260810b"><\/script><script src="assets\/premium-mailbox-ui-state\.js\?v=20260810b"><\/script>\s*<script src="assets\/premium-mailbox-boot\.js\?v=20260806a"><\/script><script src="assets\/premium-mailbox\.js\?v=20260810b"><\/script>/, file);
