  ...
  for (const file of pages) {
    ...
    if (file !== 'premium-instellingen.html') {
      if (file === 'premium-actieve-opdrachten.html') {
        assert.match(source, /<!-- SOFTORA_ACTIVE_ORDERS_BOOTSTRAP --><script src="assets\/premium-active-orders-boot\.js\?v=20260710a" defer><\/script><script src="assets\/premium-active-orders-assignee\.js\?v=20260505a" defer><\/script><script src="assets\/premium-personal-assignment-filter\.js\?v=20260510a" defer><\/script><script src="assets\/premium-active-orders-customer-db\.js\?v=20260510a" defer><\/script><script src="assets\/premium-actieve-opdrachten\.js\?v=20260710a" defer><\/script><script src="assets\/premium-active-orders-edit-data\.js\?v=20260629a" defer><\/script><script src="assets\/premium-personal-assignment-pages\.js\?v=20260510a" defer><\/script>/, file);
        ...
        assert.match(source, /<script src="assets\/premium-ui-state-client\.js\?v=20260605a"><\/script>\s*<script src="assets\/premium-notepad\.js\?v=20260519a"><\/script>/, file);
        ...
        assert.match(source, /<script src="assets\/premium-ui-state-client\.js\?v=20260605a"><\/script>\s*<script src="assets\/premium-word\.js\?v=20260616a"><\/script>/, file);
        ...
        assert.match(source, /<script src="assets\/premium-ui-state-client\.js\?v=20260605a"><\/script>\s*<script src="assets\/premium-bookkeeping\.js\?v=20260427a"><\/script>/, file);
