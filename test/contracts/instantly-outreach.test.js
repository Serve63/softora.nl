...
function assertInstantlyHtmlUsesVisibleWebdesignImages(html, expectedPath = '/webdesign/bakkerij-zon?cid=prospect-1&sender=serve') {
  ...
  assert.match(html, /class="softora-webdesign-image-pair" style="max-width:572px;width:100%;font-size:0;line-height:0;margin:0;padding:0;"/);
  assert.match(html, /class="softora-webdesign-image-cell" style="display:inline-block;width:280px;max-width:100%;vertical-align:top;margin:0 12px 16px 0/);
  assert.match(html, /class="softora-webdesign-image-cell" style="display:inline-block;width:280px;max-width:100%;vertical-align:top;margin:0 0 16px 0/);
  assert.match(imageTags[0], /width="280"/);
  assert.match(imageTags[0], /class="softora-webdesign-image"/);
  assert.match(imageTags[0], /style="display:block;width:280px;max-width:100%;height:auto;border:0;outline:none;text-decoration:none;border-radius:6px;"/);
  assert.match(imageTags[1], /width="280"/);
  assert.match(imageTags[1], /class="softora-webdesign-image"/);
  assert.match(imageTags[1], /style="display:block;width:280px;max-width:100%;height:auto;border:0;outline:none;text-decoration:none;border-radius:6px;"/);
