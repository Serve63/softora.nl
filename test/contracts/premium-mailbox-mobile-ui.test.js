...
test('mailbox laadt de pagina-eigen mobiele laag als laatste en ondersteunt veilige schermranden', () => {
  ...
  assert.ok(page.indexOf('premium-mailbox-mobile.css?v=20260821b') > page.indexOf('</style>'));
  assert.ok(page.indexOf('premium-mailbox-mobile.js?v=20260728a') > page.indexOf('premium-mailbox.js?v=20260821a'));
