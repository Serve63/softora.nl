  ...
  return [
    {
      ...
      run(assert) {
        ...
        assert(result.best.statistical?.verdict === 'PASS', 'Profit Factor Lab mist trial-ledger validatie op de beste kandidaat.');
        assert(result.best.costStress?.verdict === 'PASS', 'Profit Factor Lab mist kostenstress-validatie op de beste kandidaat.');
