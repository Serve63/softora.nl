...
const { computeInt16Rms, createSpeechTurnState } = require('./audio-turn-state');
const {
...
function shouldForwardToGeminiPcmFrame(pcm16, rmsThreshold = 400) {
  return computeInt16Rms(pcm16) >= rmsThreshold;
}
...
server.listen(PORT, () => {
  ...
  console.log('[Bridge] outputPath=direct-twilio');
});
