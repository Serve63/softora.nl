...
- Nieuwe publieke groeipagina: lever per succesvolle niet-P0-run precies een nieuwe indexeerbare `editorial`- of `money_page`-URL op wanneer de live 7-daagse target nog niet is gevuld. De geplande dagelijkse heartbeat stuurt zo op zeven nieuwe groei-URL's per rollende 7 dagen.
